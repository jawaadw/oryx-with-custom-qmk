...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, LSFT(KC_Q),     LSFT(KC_W),     LSFT(KC_E),     LSFT(KC_R),     KC_TRANSPARENT,                                 LSFT(KC_Y),     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LBRC,        KC_RBRC,        
    KC_TRANSPARENT, LSFT(KC_A),     LSFT(KC_S),     KC_TILD,        LALT(KC_H),     KC_TRANSPARENT,                                 LSFT(KC_H),     KC_TRANSPARENT, LSFT(KC_N),     KC_TRANSPARENT, KC_COLN,        KC_TRANSPARENT, 
